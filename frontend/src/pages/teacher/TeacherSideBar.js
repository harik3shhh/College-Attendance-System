        ...
        <>
            <React.Fragment>
                ...
                <ListItemButton component={Link} to="/Teacher/leave-request">
                    <ListItemIcon>
                        <AnnouncementOutlinedIcon color={location.pathname.startsWith("/Teacher/leave-request") ? 'primary' : 'inherit'} />
                    </ListItemIcon>
                ...
                <ListItemButton component={Link} to="/Teacher/get-leave-request">
                    <ListItemIcon>
                        <AnnouncementOutlinedIcon color={location.pathname.startsWith("/Teacher/get-leave-request") ? 'primary' : 'inherit'} />
                    </ListItemIcon>
                ...
                <ListItemButton component={Link} to="/student/view-attendance">
                    <ListItemIcon>
                        <ClassOutlinedIcon color={location.pathname.startsWith("/student/view-attendance") ? 'primary' : 'inherit'} />
                    </ListItemIcon>
